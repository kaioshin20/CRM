...
import {editGRNById} from '../../../../../actions/grnActions'
import {deleteGRNById} from '../../../../../actions/grnActions'
...
class GRNEdit extends Component {
    ...
    handleDelete(){
        this.props.deleteGRNById(this.state._id,this.props.history)
...
const  {List, Warehouse_code,
    ...
    this.props.editGRNById(this.state,this.state._id,this.props.history)
    ...
    render() {
        ...
        console.log("grn in eid",this.props.grn)
        const {
            Warehouse_code,
    Warehouse_name,
    Depositor_code,
...
GRNEdit.propType={
    editGRNById : PropTypes.func.isRequired,
    deleteGRNById : PropTypes.func.isRequired,
...
export default connect(mapStateToProps,{editGRNById,deleteGRNById})(withRouter(withStyles(styles)(GRNEdit)));
