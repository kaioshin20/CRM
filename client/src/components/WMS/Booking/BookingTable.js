...
const headCells = [
  ...
  { id: 'product_quantity', numeric: true, disablePadding: false, label: 'Quantity' },
  { id: 'shipping_address', numeric: false, disablePadding: false, label: 'Address' },
  { id: 'shipping_email', numeric: false, disablePadding: false, label: 'Email' },
  { id: 'shipping_status', numeric: false, disablePadding: false, label: 'Status' },
  { id: 'created', numeric: false, disablePadding: false, label: 'Booking Date' },
...
export default function BookingTable({booking_rows}) {
...
if(filterType === 4){
      ...
      return booking_rows.filter((row) => { return row._id.search(keyword) > -1 || (row.product_name).search(keyword) > -1 || (row.product_category).search(keyword) > -1 || (row.shipping_address).search(keyword) > -1 || (row.shipping_email).search(keyword) > -1  })
    }
  }
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="right">{row.shipping_email}</TableCell>
