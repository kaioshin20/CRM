...
import {createNewPickList} from '../../../../../actions/pickListActions'
...
class PickListForm extends Component {
    ...
    handleSubmit(){
// let {    Required_qty,Stack_qty}  = this.state

// Required_qty = parseInt(Required_qty)
// Stack_qty = parseInt(Stack_qty)

// this.setState({Required_qty:Required_qty,Stack_qty:Stack_qty})
...
const  { Dispatch_no,
    ...
    this.props.createNewPickList(this.state,this.props.history)
...
PickListForm.propType={
    createNewPickList : PropTypes.func.isRequired,
...
export default connect(mapStateToProps,{createNewPickList})(withRouter(withStyles(styles)(PickListForm)));
